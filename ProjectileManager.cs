...
namespace RoomGenerator
{
    ...
    public class Projectile
    {
        ...
        public void Draw()
        {
            if (m_IsAlive)
            {
                Utility.Instance.SB.Draw(m_Texture, GetDrawnRect, m_Colour);
            }

#if DEBUG
            Utility.Instance.SB.Draw(Utility.Instance.WhiteSquare, new Rectangle((int)m_Position.X, (int)m_Position.Y, 3, 3), Color.White);
            Utility.Instance.SB.Draw(Utility.Instance.WhiteSquare, new Rectangle((int)(m_Position.X + m_Dimensions.X * 0.5f), (int)(m_Position.Y + m_Dimensions.Y * 0.5f), 3, 3), Color.White);
#endif
        }
