...
namespace RoomGenerator
{
    ...
    public class Dungeon
    {
        ...
        public Dungeon(int dungeonWidth, int dungeonHeight, int roomSize)
        {
            ...
            player = new Player(new Vector2(Utility.Instance.ScreenWidth / 2, Utility.Instance.ScreenHeight / 2), new Vector2(10));
            ...
            if (m_CurrentRoom.Defeated)
            {
                ...
                if (m_CurrentRoom.CheckDoorCollidable(Direction.NORTH) && player.Intersects(m_CurrentRoom.GetDoorCollider(Direction.NORTH)))
                {
                    ...
                    if (northOfCurrent != -1)
                    {
                        ...
                        if (nextRoom.GetRoomType != PreRoomType.NO_ROOM)
                        {
                            ...
                            player.Position = new Vector2(Utility.Instance.ScreenWidth * 0.5f, Utility.Instance.ScreenHeight - 100);
                ...
                if (m_CurrentRoom.CheckDoorCollidable(Direction.SOUTH) && player.Intersects(m_CurrentRoom.GetDoorCollider(Direction.SOUTH)))
                {
                    ...
                    if (southOfCurrent != -1)
                    {
                        ...
                        if (nextRoom.GetRoomType != PreRoomType.NO_ROOM)
                        {
                            player.Position = new Vector2(Utility.Instance.ScreenWidth * 0.5f, 50);
                ...
                if (m_CurrentRoom.CheckDoorCollidable(Direction.EAST) && player.Intersects(m_CurrentRoom.GetDoorCollider(Direction.EAST)))
                {
                    ...
                    if (eastOfCurrent != -1)
                    {
                        ...
                        if (nextRoom.GetRoomType != PreRoomType.NO_ROOM)
                        {
                            ...
                            player.Position = new Vector2(50, Utility.Instance.ScreenHeight * 0.5f);
                ...
                if (m_CurrentRoom.CheckDoorCollidable(Direction.WEST) && player.Intersects(m_CurrentRoom.GetDoorCollider(Direction.WEST)))
                {
                    ...
                    if (westOfCurrent != -1)
                    {
                        ...
                        if (nextRoom.GetRoomType != PreRoomType.NO_ROOM)
                        {
                            ...
                            player.Position = new Vector2(Utility.Instance.ScreenWidth - 100, Utility.Instance.ScreenHeight * 0.5f);
        ...
        public void ResetDungeon(bool reset = true)
        {
            ...
            while (counter < maxCounter)
            {
                ...
                if (m_CurrentRoom != null && numFilledRooms > m_MinRooms && numFilledRooms < m_MaxRooms)
                {
        ...
        void SpecialisePreRooms()
        {
            ...
            for (int i = 0; i < m_PreRooms.Count; ++i)
            {
                ...
                Console.WriteLine(current.GetRoomType);
            ...
            Console.WriteLine("ASSIGNED NEW TO OLD");
            m_PreRooms = local;
        }
        ...
        public void DrawMiniMap(PreRoomType typeToHighlight = PreRoomType.NO_ROOM)
        {
            ...
            Utility.Instance.SB.DrawString(Utility.Instance.SF, "H", new Vector2(m_StartPos.X + m_CurrentRoom.X * (m_RoomWidth) - 0.5f, m_StartPos.Y + m_CurrentRoom.Y * (m_RoomHeight)), Color.White);
            Utility.Instance.SB.DrawString(Utility.Instance.SF, "H", new Vector2(m_StartPos.X + m_CurrentRoom.X * (m_RoomWidth) - 0.5f, m_StartPos.Y + m_CurrentRoom.Y * (m_RoomHeight)), Color.Black);
        }
        ...
        public void DrawDoors()
        {
            ...
            if (m_CurrentRoom.GetConnection(Direction.NORTH) != -1)
            {
                ...
                {
                    Utility.Instance.SB.Draw(Utility.Instance.WhiteSquare, m_CurrentRoom.GetDoorCollider(Direction.NORTH), Color.RoyalBlue);
                }
            }
            ...
            if (m_CurrentRoom.GetConnection(Direction.SOUTH) != -1)
            {
                ...
                {
                    Utility.Instance.SB.Draw(Utility.Instance.WhiteSquare, m_CurrentRoom.GetDoorCollider(Direction.SOUTH), Color.RoyalBlue);
                }
            }
            ...
            if (m_CurrentRoom.GetConnection(Direction.EAST) != -1)
            {
                ...
                {
                    Utility.Instance.SB.Draw(Utility.Instance.WhiteSquare, m_CurrentRoom.GetDoorCollider(Direction.EAST), Color.RoyalBlue);
                }
            }
            ...
            if (m_CurrentRoom.GetConnection(Direction.WEST) != -1)
            {
                ...
                {
                    Utility.Instance.SB.Draw(Utility.Instance.WhiteSquare, m_CurrentRoom.GetDoorCollider(Direction.WEST), Color.RoyalBlue);
                }
            }
        }
